...
<style>
  ...
  .consigliato-box {{ background: #0a1628; border: 2px solid #60A5FA; border-radius: 8px; padding: 20px 24px; margin-bottom: 32px; }}
  .consigliato-box .badge {{ background: #60A5FA; color: #000; font-weight: 700; font-size: 12px; padding: 3px 12px; border-radius: 20px; display: inline-block; margin-bottom: 10px; }}
